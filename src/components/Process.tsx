...
const steps = [
  {
    ...
    title: "Дыхание",
    description:
      "Каждое занятие начинается с остановки. Мы учимся дышать осознанно — это основа и йоги, и пилатеса, и любого движения.",
  },
  {
    number: "02",
    title: "Центр",
    description:
      "Сила рождается из глубины. Мы активируем центральные мышцы — не для рельефа, а для устойчивости, которую чувствуешь в жизни.",
  },
  {
    number: "03",
    title: "Движение",
    description:
      "Тело раскрывается постепенно. Асаны, упражнения на реформере, медленные потоки — каждый шаг осмысленный и точный.",
  },
  {
    number: "04",
    title: "Интеграция",
    description:
      "Практика не заканчивается на коврике. Мы помогаем перенести состояние осознанности в повседневную жизнь.",
  },
]
