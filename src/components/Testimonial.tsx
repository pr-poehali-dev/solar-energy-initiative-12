  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Пришла к Елене с хронической болью в спине и полным скептицизмом. Через три месяца боль ушла, а йога стала частью моего утра. Елена умеет объяснять так, что всё встаёт на своё место — и в теле, и в голове.
        </blockquote>
        ...
        >
          ...
          <p className="text-sm text-primary-foreground/60 mt-1">Ученица студии, Москва</p>
        </div>
      </div>
    </section>
  )
